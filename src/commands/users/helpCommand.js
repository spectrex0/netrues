        ...
        if (message.content.trim() === '-help') {
            try {
                const helpEmbed = new EmbedBuilder()
                    ...
                    .addFields({ name: '`/avatar`', value: 'Gets the avatar of a user.', inline: true }, { name: '`-cat`', value: 'Shows random cat images.', inline: true }, { name: '`-fact`', value: 'Sends an interesting fact.', inline: true }, { name: '`-quote`', value: 'Sends a  random quote.', inline: true }, { name: '`-meme`', value: 'Sends a random meme.', inline: true })
