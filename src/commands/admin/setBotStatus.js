...
export const data = new SlashCommandBuilder()
    ...
    .addStringOption((option) => option.setName("text").setDescription("Custom text").setRequired(true))
    .addStringOption((option) => option
    .setName("type")
    .setDescription("Kind of activity")
    .setRequired(true)
    .addChoices({ name: "Playing", value: "PLAYING" }, { name: "Streaming", value: "STREAMING" }, { name: "Listening", value: "LISTENING" }, { name: "watching", value: "WATCHING" }, { name: "Competing", value: "COMPETING" }));
export async function execute(interaction) {
    ...
    try {
        ...
        await interaction.editReply(`Changed to: **${typeValue.toLowerCase()} ${text}**.`);
    }
    catch (error) {
...
//# sourceMappingURL=setBotStatus.js.map